...
$_['text_order_confirmation']                 = 'Order Confirmation:'; //[SB] Added
...
$_['text_reward_add']                         = 'Add VIT$'; //[SB] Changed Reward Points
$_['text_reward_added']                       = 'Success: VIT$ added!'; //[SB] Changed Reward Points
$_['text_reward_remove']                      = 'Remove VIT$'; //[SB] Changed Reward Points
$_['text_reward_removed']                     = 'Success: VIT$ removed!'; //[SB] Changed Reward Points
$_['text_referral_confirm']                   = 'Confirm Referral'; //[SB] Added Referral
$_['text_referral_confirmed']                 = 'Success: Referral confirmed!'; //[SB] Added Referral
$_['text_referral_remove']                   = 'Remove Referral'; //[SB] Added Referral
$_['text_referral_removeed']                 = 'Success: Referral removed!'; //[SB] Added Referral
...
$_['text_redemption_redeem_r']    = 'VIT$ ';

// Column
$_['column_order_id']                         = 'Order ID';
$_['column_invoice'] = 'Order Confirmation'; //[SB] Added invoice
$_['column_customer']                         = 'Customer';
$_['column_email'] = 'Email'; //[SB] Added email
...
$_['entry_reward']                            = 'VIT$:'; //[SB] Changed Reward
$_['entry_referral']                          = 'Referral:'; //[SB] Changed Referral
...
//[SB] Added Referral
$_['mail_referral_subject']  = '%s - Referral Coupon';
$_['mail_referral_text']  = 'Thank you for shopping with %s.<br><br>
We are pleased to offer you a <strong>$%s</strong> off your next purchase. Simply key in coupon code* <strong>%s</strong> upon checkout.<br><br>
<strong>*Valid with min spend of $%s.</strong>
<br><br>
-----
<br><br>
Cheers,<br>
%s Team';
$_['mail_address'] = "<strong>Sainhall Nutrihealth Pte Ltd</strong><br>59 Jalan Pemimpin<br>#02-02 L&Y Building<br>Singapore 577218<br><strong>Hotline:</strong> +65 6255 7533<br><strong>Operating hours:</strong> Mon - Fri, 9am to 5pm";

$_['mail_dear']          = 'Dear %s';
$_['description_referral_reward']  = 'Referral of %s';
?>