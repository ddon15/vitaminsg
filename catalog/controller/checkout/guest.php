...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		if (isset($this->session->data['guest']['password'])) {
			$this->data['password'] = $this->session->data['guest']['password'];
		} else {
			$this->data['password'] = '';
		}

		if (isset($this->session->data['guest']['confirm'])) {
			$this->data['confirm'] = $this->session->data['guest']['confirm'];
		} else {
			$this->data['confirm'] = '';
		}
	...
	public function validate() {
		...
		if (!$json) {
			...
			$this->session->data['guest']['payment']['email'] = $this->request->post['email'];
			$this->session->data['guest']['payment']['telephone'] = $this->request->post['telephone'];
			$this->session->data['guest']['payment']['dob'] = $this->request->post['dob'];
			$this->session->data['guest']['payment']['password'] = $this->request->post['password'];
