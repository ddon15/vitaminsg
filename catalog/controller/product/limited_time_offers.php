<?php 
class ControllerProductLimitedTimeOffers extends Controller { 	
	public function index() { 
    	$this->language->load('product/limited_time_offers');
		...
		if (isset($this->request->get['limit'])) {
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('product/limited_time_offers', $url),
		...
		$product_total = $this->model_catalog_product->getTotalProductPromos($data);
			
		$results = $this->model_catalog_product->getProductPromos($data);
		...
		foreach ($results as $result) {
			...
			$this->data['products'][] = array(
				...
				'brand'       => $result['manufacturer'], //[SB] Added brands
				'brand_url'   => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $result['manufacturer_id']) //[SB] Added brands
			);
		}
