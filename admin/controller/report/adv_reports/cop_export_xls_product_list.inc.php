...
ini_set("memory_limit","256M");
	...
	isset($_POST['cop30']) ? $export_xls_product_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".$result['total']."</td>" : '';
	isset($_POST['cop29']) ? $export_xls_product_list .= "<td align='right' style='background-color:#DCFFB9; mso-number-format:#\,\#\#0\.00'>".$total_sales."</td>" : '';
	isset($_POST['cop31']) ? $export_xls_product_list .= "<td align='right' style='background-color:#ffd7d7; mso-number-format:#\,\#\#0\.00'>".('-' . $total_costs)."</td>" : '';
	isset($_POST['cop32']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".($total_sales-$total_costs)."</td>" : '';
	if ($total_costs > 0) {				
	isset($_POST['cop33']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold;'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['cop33']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold;'>".'100%'."</td>" : '';
	}							
	$export_xls_product_list .="</tr>";
	$export_xls_product_list .="<tr>";
	...
	isset($_POST['cop30']) ? $export_xls_product_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['value_total']."</td>" : '';	
	isset($_POST['cop29']) ? $export_xls_product_list .= "<td align='right' style='background-color:#DCFFB9; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$total_sales_total."</td>" : '';
	isset($_POST['cop31']) ? $export_xls_product_list .= "<td align='right' style='background-color:#ffd7d7; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".('-' . $total_costs_total)."</td>" : '';	
	isset($_POST['cop32']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".($total_sales_total-$total_costs_total)."</td>" : '';
	if ($total_costs_total > 0) {
	isset($_POST['cop33']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold;'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['cop33']) ? $export_xls_product_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold;'>".'100%'."</td>" : '';	
	}
