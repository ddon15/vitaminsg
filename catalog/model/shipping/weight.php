				...
				foreach ($rates as $rate) {
					...
					if ($data[0] >= $weight) {
						...
						break;
                                ...
                                //[MY] customised shipping messages superhackish
                                if($result['name'] === 'Singapore'){
                                    $result['name'] = 'Local Delivery (Singapore only)';
                                }
                                if($result['name']==='Overseas'){
                                    $result['name'] = 'Overseas Delivery (outside Singapore)';
                                }
                                //.[MY]
				if ((string)$cost != '') { 
