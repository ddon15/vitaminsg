      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <table class="form">
              ...
              <td><?php echo $entry_cptitle; ?></td><td><input type="text" id="cpinfo" maxlength="255" name="product_description[<?php echo $language['language_id']; ?>][cptitle]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['cptitle'] : ''; ?>" /></td></tr><?php/*CPT1 END*/?>
			  ...
			  <tr><?php //[SB]Add Additional Info field ?>

                <td><?php echo $entry_additional_info; ?></td>

                <td><textarea name="product_description[<?php echo $language['language_id']; ?>][additional_info]" id="additional_info<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['additional_info'] : ''; ?></textarea></td>
        ...
        <div id="tab-data">
          ...
          <table class="form">
            ...
            <?php if(!empty($date_expiry)){?>

            <tr>

              <td><?php echo $entry_date_expiry; ?></td>

              <td><input type="text" name="date_expiry" value="<?php echo $date_expiry; ?>" size="12" class="date" /></td>
          ...
          <table id="discount" class="list">
            ...
            <thead>
              ...
              <tr>
                ...
                <td class="right">Original Price</td>
        ...
        <div id="tab-reward">
          ...
          <table class="form">
			...
			<!--[SB] Added Redemption -->
				...
				<td><?php echo $entry_redeem_only ?></td>

				<td><input type="checkbox" name="vit_redeem_only" value="vit_redeem_only"

					<?php if($redeem_only) { ?> checked <?php } ?>/>
...
<?php/*CPT2 START*/?><script type="text/javascript" src="view/javascript/jquery/charCount.js"></script><script type="text/javascript">$(document).ready(function(){$("#cpinfo").charCount();});</script><style>.counter{margin-left:20px;}.counter.exceeded {font-weight:bold;color:#FC1501}.optimum{margin-left:25px;color:#55AE3A;font-weight:bold;}</style><?php/*CPT2 END*/?>
...
CKEDITOR.replace('additional_info<?php echo $language['language_id']; ?>', {
...
//[MY] hide useless tabs . meipeng request

$('a[href="#tab-attribute"]').hide();

//$('a[href="#tab-option"]').hide();

$('a[href="#tab-profile"]').hide();

$('a[href="#tab-design"]').hide();
...
<?php //[MY] hide marketplace links.. ?>

<?php if (false && isset($this->request->get['product_id'])) { ?>
