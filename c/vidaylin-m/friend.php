					...
					<form role="form" method="POST">
						...
						<div class="row">
							<div class='col-sm-12'>
								...
								<h1>Help <?php echo $member['name']; ?> get Vidaylin Minibear Gummies for free, and get it for yourself at just S$5!</h1>
								<p>Here's how:</p>
								...
								<p style="font-size: 1.2em;"><strong>2.	Get Vidaylin Minibear Gummies for S$5 (U.P. S$23.80)</strong></p>
								<p>Because of <?php echo $member['name']; ?>'s invitation, you can now purchase a bottle of Vidaylin Minibear Gummies from Vitamin.sg for just S$5 - that's a whopping 79% discount! Delivery is free! </p>
								<div class="aboutvidaylin clearfix">
									...
									<p style="font-style: italic; font-weight: bold; font-size: 1.2em; margin-top: 30px; margin-bottom: 30px; color: #777;">
										...
										Because you, your friend, and your children benefit!<br />
								...
								<p>When you purchase a bottle of Vidaylin Minibear Gummies, <?php echo $member['name']; ?> also gets a bottle for free! Both you and <?php echo $member['name']; ?> also get to enjoy these benefits:</p>
								<ul>
								...
								<p><strong>HURRY! This offer ends on 22 February 2015!</strong></p>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class='your-details'>
									<h3 id="theform">Fill in the form below to purchase Vidaylin Minibear Gummies (worth $23.80) for $5!</h3>
							...
							<div class="col-sm-12 tncs">
								...
								<p><input type="submit" class="btn btn-lg btn-danger" value="Purchase Vidaylin Minibear Gummies (U.P. $23.80) for S$5! &raquo;" />
