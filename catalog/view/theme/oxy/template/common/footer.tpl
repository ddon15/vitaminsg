...
<span class="p_title" style="text-transform:inherit;">
    <?php //malcolm ?>
    Partners
    <?php //echo '<a href=\"#\" data-reveal-id=\"oxyModal1\">'. $oxy_fp_fb1_title.' </a>'; ?>
</span>
...
<div id="footer_a_2" class="s<?php echo 12 / ($this->config->get('oxy_custom_1_status') + $this->config->get('oxy_custom_2_status') + $this->config->get('oxy_follow_us_status') + $this->config->get('oxy_contacts_status')) ; ?> columns">
		...
		<?php } ?>  
        <?php //[SB]replace with subscribe echo htmlspecialchars_decode($oxy_custom_2_content);
		include 'vit_newsletter_subscribe.tpl';?>
</div>
<?php } ?>
<?php } ?>
...
<?php //[SB] Custom Vitamin.sg footer ?>
<div id="footer_c"><div class="row">
	<div id="footer_c_1" class="s3 columns">
		<h3><?php echo $text_service; ?></h3>
		<ul>
			<li><a href="<?php echo $link_faq; ?>"><?php echo $text_faq; ?></a></li>
			<li><a href="<?php echo $link_suggest_product; ?>"><?php echo $text_suggest_product; ?></a></li>
			<li><a href="<?php echo $link_track_order; ?>"><?php echo $text_track_order; ?></a></li>
			<li><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
			<li><a href="<?php echo $link_notices; ?>"><?php echo $text_notices; ?></a></li>
		</ul>
	</div>
	
	<div id="footer_c_2" class="s3 columns">
		<h3><?php echo $text_healthy_insider; ?></h3>
		<ul>
			<li><a href="<?php echo $link_health_articles; ?>"><?php echo $text_health_articles; ?></a></li>
			<li><a href="<?php echo $link_membership; ?>"><?php echo $text_membership; ?></a></li>
			<li><a href="<?php echo $link_rewards; ?>"><?php echo $text_rewards_program; ?></a></li>
		</ul>
	</div>
	
	<div id="footer_c_3" class="s3 columns">
		<h3><?php echo $text_corporate_enquiry; ?></h3>
		<ul>
			<li><a href="<?php echo $link_partnership; ?>"><?php echo $text_partnership; ?></a></li>
			<li><a href="index.php?route=affiliate/account" style="color:#8C8C8C;"><?php echo $text_affiliate_program; ?></span></li>
			<li><a href="<?php echo $link_corporate_sales; ?>"><?php echo $text_corporate_sales; ?></a></li>
			<li><a href="<?php echo $link_careers; ?>"><?php echo $text_careers; ?></a></li>
		</ul>
	</div>
	
	<div id="footer_c_4" class="s3 columns">
		<img id="paypal_footer" src="<?php echo $img_paypal; ?>" />
		<p><?php echo $text_paypal_footer; ?></p>
	</div>
