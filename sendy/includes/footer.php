<hr>
	      ...
	      <footer>
	        ...
	        <p>
	        	&copy; <?php echo date("Y",time())?> <a href="http://sendy.co" title="" target="_blank">Sendy</a> | <a href="http://sendy.co/troubleshooting" target="_blank">Troubleshooting</a> | <a href="https://sendy.co/forum/" target="_blank">Support forum</a> | Version <?php echo get_app_info('version');?> 
	        	<?php 
