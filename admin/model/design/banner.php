	...
	public function addBanner($data) {
		...
		if (isset($data['banner_image'])) {
			foreach ($data['banner_image'] as $banner_image) {
				$this->db->query("INSERT INTO " . DB_PREFIX . "banner_image SET banner_id = '" . (int)$banner_id . "', link = '" .  $this->db->escape($banner_image['link']) . "', image = '" .  $this->db->escape($banner_image['image']) . "', date_start = '" .  $this->db->escape($banner_image['date_start']) . "', date_end = '" .  $this->db->escape($banner_image['date_end']) . "'"); //[SB] Added start/end date
	...
	public function getBannerImages($banner_id) {
		...
		foreach ($banner_image_query->rows as $banner_image) {
			...
			$banner_image_data[] = array(
				...
				'date_start'               => $banner_image['date_start'],
				'date_end'                 => $banner_image['date_end']
			);
		}
