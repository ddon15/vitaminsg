...
class ControllerSaleCustomer extends Controller { 
	...
	protected function getList() {
		//[SB] Added Member Num
		if (isset($this->request->get['filter_member_num'])) {
			$filter_member_num = $this->request->get['filter_member_num'];
		} else {
			$filter_member_num = null;
		}
		...
		*/
		...
		if (isset($this->request->get['filter_claim_code'])) {
			$filter_claim_code = $this->request->get['filter_claim_code'];
		} else {
			$filter_claim_code = null;
		}
		...
		//[SB] Added Member Num
		if (isset($this->request->get['filter_member_num'])) {
			$url .= '&filter_member_num=' . $this->request->get['filter_member_num'];
		}
		...
		if (isset($this->request->get['filter_claim_code'])) {
			$url .= '&filter_claim_code=' . $this->request->get['filter_claim_code'];
		}
		...
		*/
		...
		$data = array(
			'filter_member_num'        	=> $filter_member_num, //[SB] Added Member Num
			...
			//'filter_ip'                => $filter_ip, //[SB] took out ip
			'filter_expiry'        	=> $filter_expiry, //[SB] Added expiry
			'sort'                     => $sort,
			'order'                    => $order,
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('sale/customer/update', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['cust_id'] . $url, 'SSL')

			);

			$this->data['customers'][] = array(
				'customer_id'    => $result['customer_id']?$result['customer_id']:$result['cust_id'],
				'member_num'	=> $result['member_num'], //[SB] Added Member Num
				'name'           => $result['name'],
				'email'          => $result['email']?$result['email']:$result['cust_email'],
				'customer_group' => $result['customer_group'],
				'status'         => ($result['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				'approved'       => ($result['approved'] ? $this->language->get('text_yes') : $this->language->get('text_no')),
				'claim_code'	=>  $result['claim_code'],
				'ip'             => $result['ip'],
				'expiry'     => date($this->language->get('date_format_short'), strtotime($result['expiry'])), //[SB] Added expiry
		...
		//[SB] Added Member Num
		$this->data['column_member_num'] = $this->language->get('column_member_num');
		...
		$this->data['column_claim_code'] = $this->language->get('column_claim_code');
		...
		//[SB] Added Member Num
		if (isset($this->request->get['filter_member_num'])) {
			$url .= '&filter_member_num=' . urlencode(html_entity_decode($this->request->get['filter_member_num'], ENT_QUOTES, 'UTF-8'));
		}
		...
		*/
		...
		//[SB] Added Member Num
		$this->data['sort_member_num'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=member_num' . $url, 'SSL');
		...
		$this->data['sort_claim_code'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=claim_code' . $url, 'SSL');

		//[SB] took out ip, added expiry
		//$this->data['sort_ip'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=c.ip' . $url, 'SSL');
		$this->data['sort_expiry'] = $this->url->link('sale/customer', 'token=' . $this->session->data['token'] . '&sort=expiry' . $url, 'SSL');
		...
		*/
		...
		$this->data['filter_member_num'] = $filter_member_num;
		$this->data['filter_name'] = $filter_name;
		$this->data['filter_email'] = $filter_email;
		$this->data['filter_customer_group_id'] = $filter_customer_group_id;
		$this->data['filter_status'] = $filter_status;
		$this->data['filter_approved'] = $filter_approved;
		//$this->data['filter_ip'] = $filter_ip; [SB] Took out ip
		$this->data['filter_expiry'] = $filter_expiry; // [SB] added expiry
		$this->data['filter_date_added'] = $filter_date_added;
		$this->data['filter_claim_code'] = $filter_claim_code;
	...
	protected function getForm() {
		...
		$this->data['entry_member_num'] = $this->language->get('entry_member_num');
		...
		if (isset($this->error['address_zone'])) {
			$this->data['error_address_zon
			e'] = $this->error['address_zone'];
		} else {
		...
		$this->data['member_num'] = $customer_info['member_num'];
		...
		if (isset($this->request->post['id_number'])) {
			...
			$this->data['id_number'] = $customer_info['id_number'];
		} else {
			$this->data['id_number'] = '';
		}
		...
		if (isset($this->request->post['expiry'])) {
			...
			$this->data['expiry'] = date('Y-m-d', strtotime($customer_info['expiry']));
		} else {
			$this->data['id_number'] = '';
		}
		if (isset($this->request->post['sms'])) {
			...
			$this->data['sms'] = $customer_info['sms'];
		} else {
			$this->data['sms'] = '';
		}
		...
		// lw: added for claim code
		if (!empty($customer_info)) {
			$this->data['claim_code'] = $customer_info['claim_code'];
		} else {
