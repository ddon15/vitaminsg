...
<section id="content" class="columns op"><?php echo $content_top; ?>
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
		...
		<h2><?php echo $text_claim_code; ?></h2>
		<div class="content">
			<p><?php echo $text_claim_code_instruction; ?></p>
			<table class="form">
				<tr>
					<td>&nbsp;&nbsp;&nbsp;<?php echo $entry_claim_code; ?></td>
					<td><input type="text" name="claim_code" size="20" maxlength="20" value="<?php echo $claim_code; ?>" />
						<?php if ($error_claim_code) { ?>
						<span class="error"><?php echo $error_claim_code; ?></span>
						<?php } ?></td>
				</tr>
				</table>
		</div>
