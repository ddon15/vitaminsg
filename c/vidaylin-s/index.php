					...
					<form role="form" method="POST">
						...
						<div class="row">
							<div class='col-sm-12'>
								...
								<h1>Get Your Free Gift (Worth $58.80) Today!</h1>	
								<p>Here's how:</p>
							...
							<div class='col-sm-12'>
								<p style="font-size: 200%; font-weight: bold; color: #f00; text-align: center; margin-top: 15px;">Total: S$117.60 between you and your friend... <br />That's S$58.80 each!</p>
<!-- 								<p style="text-align: center; font-weight: bold; ">Offer ends on 8 March 2015. <br />Get it fast before its gone - refer 5 friends today!</p>  -->
							</div>
						</div>
...
<div class='tncwrap hidden'>
	...
	<ul>
		...
		<li>Limited to one bottle per subscriber.</li>
		...
		<li>All benefits of this campaign are awarded on the condition that the referred friend(s) of the Vitamin.sg customer make a purchase of Vidaylin Minibear Gummies via their unique referral link. Every Vitamin.sg subscriber is entitled to a maximum of 1 free bottle of Vidaylin Minibear Gummies. </li>
	</ul>
	</div>
</div>	
