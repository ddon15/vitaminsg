...
<style type="text/css">
  ...
  <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').attr('target', '_self'); $('#form').submit();" class="button"><span><?php echo $button_copy; ?></span></a><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a onclick="document.getElementById('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
