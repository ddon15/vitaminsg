			...
			<div id="content" class="row">	
				<div class="col-sm-12">
					...
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post" style="display: none;">
						...
						<input type="hidden" name="return" 				value="http://www.vitamin.sg/c/vidaylin-s/thankyou.php">
						<input type="hidden" name="cancel_return" 		value="http://www.vitamin.sg/c/vidaylin-s/friend.php?r=<?php echo $referral['hash'] ?>">
						<input type="hidden" name="notify_url" 			value="http://www.vitamin.sg/c/vidaylin-s/ipn.php">
