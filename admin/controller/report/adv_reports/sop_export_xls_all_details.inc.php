...
ini_set("memory_limit","256M");
	...
	isset($_POST['sop1000']) ? $export_xls_all_details .= "<td align='left' style='background-color:#EFEFEF; font-weight:bold;'>".$this->language->get('column_order_inv_no')."</td>" : '';	
	...
	isset($_POST['sop1000']) ? $export_xls_all_details .= "<td align='left' valign='top' style='mso-ignore: colspan'>".$result['order_inv_no']."</td>" : '';
	...
	isset($_POST['sop1020']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_sub_total']."</td>" : '';
	isset($_POST['sop1021']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_handling']."</td>" : '';	
	isset($_POST['sop1022']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_low_order_fee']."</td>" : '';	
	if ($this->config->get('adv_profit_reports_formula_sop1')) {
	isset($_POST['sop1023']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_shipping']."</td>" : '';
	} else {
	isset($_POST['sop1023']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_shipping']."</td>" : '';
	}	
	isset($_POST['sop1024']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_reward']."</td>" : '';	
	isset($_POST['sop1025']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_coupon']."</td>" : '';
	...
	isset($_POST['sop1027']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_tax']."</td>" : '';
	isset($_POST['sop1028']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_credit']."</td>" : '';	
	isset($_POST['sop1029']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#090; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_voucher']."</td>" : '';
	...
	isset($_POST['sop1031']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_value']."</td>" : '';
	isset($_POST['sop1032']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#DCFFB9; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_sales']."</td>" : '';
	isset($_POST['sop1033']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#F00; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_product_costs']."</td>" : '';	
	isset($_POST['sop1034']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#F00; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_commission']."</td>" : '';	
	if ($this->config->get('adv_profit_reports_formula_sop3')) {
	isset($_POST['sop1035']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#F00; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_payment_cost']."</td>" : '';
	} else {
	isset($_POST['sop1035']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_payment_cost']."</td>" : '';
	}	
	if ($this->config->get('adv_profit_reports_formula_sop2')) {
	isset($_POST['sop1036']) ? $export_xls_all_details .= "<td align='right' valign='top' style='color:#F00; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_shipping_cost']."</td>" : '';
	} else {
	isset($_POST['sop1036']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_shipping_cost']."</td>" : '';
	}	
	isset($_POST['sop1037']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#ffd7d7; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_costs']."</td>" : '';
	isset($_POST['sop1038']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#c4d9ee; font-weight:bold; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_profit']."</td>" : '';
	...
	isset($_POST['sop1040']) ? $export_xls_all_details .= "<td align='left' valign='top' style='mso-ignore: colspan'>".strip_tags($result['order_shipping_method'], '<br>')."</td>" : '';
