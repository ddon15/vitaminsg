...
if (isset($this->request->get['keepediting'])) {
		...
		$this->data['tax_classes'] = $this->model_report_adv_sale_profit->getOrderTaxClasses();					
		...
		$this->data['geo_zones'] = $this->model_report_adv_sale_profit->getOrderGeoZones();					
		...
		$this->data['payment_methods'] = $this->model_report_adv_sale_profit->getOrderPaymentMethods();	
		...
		$this->data['shipping_methods'] = $this->model_report_adv_sale_profit->getOrderShippingMethods();			
		...
		$this->data['categories'] = $this->model_report_adv_sale_profit->getProductsCategories(0);	
		...
		$this->data['manufacturers'] = $this->model_report_adv_sale_profit->getProductsManufacturers(); 
		...
		$this->data['attributes'] = $this->model_report_adv_sale_profit->getProductAttributes();
		...
		$this->data['locations'] = $this->model_report_adv_sale_profit->getProductLocations();			
		...
		$this->data['affiliate_names'] = $this->model_report_adv_sale_profit->getOrderAffiliates();
		...
		$this->data['affiliate_emails'] = $this->model_report_adv_sale_profit->getOrderAffiliates();
		...
		$this->data['coupon_names'] = $this->model_report_adv_sale_profit->getOrderCouponNames();
		...
		if (isset($this->request->post['adv_profit_reports_formula_sop1']) && $this->request->post['adv_profit_reports_formula_sop1'] == 1) { 
			if ($this->config->get('adv_profit_reports_formula_sop1') == 0) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop1'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop1', `value` = '1'");
			}		
			...
			if ($this->config->get('adv_profit_reports_formula_sop1') == 1) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop1'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop1', `value` = '0'");
			}			
		}
		...
		if (isset($this->request->post['adv_profit_reports_formula_sop2']) && $this->request->post['adv_profit_reports_formula_sop2'] == 1) { 
			if ($this->config->get('adv_profit_reports_formula_sop2') == 0) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop2'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop2', `value` = '1'");
			}		
			...
			if ($this->config->get('adv_profit_reports_formula_sop2') == 1) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop2'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop2', `value` = '0'");
			}			
		}
		...
		if (isset($this->request->post['adv_profit_reports_formula_sop3']) && $this->request->post['adv_profit_reports_formula_sop3'] == 1) { 
			if ($this->config->get('adv_profit_reports_formula_sop3') == 0) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop3'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop3', `value` = '1'");
			}		
			...
			if ($this->config->get('adv_profit_reports_formula_sop3') == 1) { 
				$this->db->query("DELETE FROM " . DB_PREFIX . "setting WHERE store_id = '0' AND `group` = 'adv_profit_reports' AND `key` = 'adv_profit_reports_formula_sop3'");	
				$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = '0', `group` = 'adv_profit_reports', `key` = 'adv_profit_reports_formula_sop3', `value` = '0'");
			}			
		}

		if (isset($this->request->post['adv_profit_reports_formula_sop1'])) {
			$this->data['adv_profit_reports_formula_sop1'] = $this->request->post['adv_profit_reports_formula_sop1'];
		} else {
			$this->data['adv_profit_reports_formula_sop1'] = $this->config->get('adv_profit_reports_formula_sop1');
		}

		if (isset($this->request->post['adv_profit_reports_formula_sop2'])) {
			$this->data['adv_profit_reports_formula_sop2'] = $this->request->post['adv_profit_reports_formula_sop2'];
		} else {
			$this->data['adv_profit_reports_formula_sop2'] = $this->config->get('adv_profit_reports_formula_sop2');
		}
		
		if (isset($this->request->post['adv_profit_reports_formula_sop3'])) {
			$this->data['adv_profit_reports_formula_sop3'] = $this->request->post['adv_profit_reports_formula_sop3'];
		} else {
			$this->data['adv_profit_reports_formula_sop3'] = $this->config->get('adv_profit_reports_formula_sop3');
		}
		...
		if ($filter_details != 4) {
		$results = $this->model_report_adv_sale_profit->getSaleProfit($data);
		...
		foreach ($results as $result) {
			...
			$this->data['orders'][] = array(
				...
				'gsales'      					=> $total_sales,
				'gcosts'      					=> $total_costs,
				'gnetprofit'      				=> $total_sales-$total_costs,
		...
		$this->data['column_product_costs'] = $this->language->get('column_product_costs');		
		$this->data['column_commission'] = $this->language->get('column_commission');	
		$this->data['column_payment_cost'] = $this->language->get('column_payment_cost');
		$this->data['column_shipping_cost'] = $this->language->get('column_shipping_cost');
		$this->data['column_shipping_balance'] = $this->language->get('column_shipping_balance');
	...
	public function coupon_autocomplete() {
		...
		$results = $this->model_report_adv_sale_profit->getCouponAutocomplete($data);
	...
	public function voucher_autocomplete() {
		...
		$results = $this->model_report_adv_sale_profit->getVoucherAutocomplete($data);
