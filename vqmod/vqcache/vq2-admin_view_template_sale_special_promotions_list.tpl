                        ...
                        <?php if ($promotions) { ?>
                            <?php foreach ($promotions as $promotion) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $promotion['date_start'] == '0000-00-00' ? '' : $promotion['date_start']; ?></td>
                                    <td><?php echo $promotion['date_end'] == '0000-00-00' ? '' : $promotion['date_end']; ?></td>
                                    <td>
                                        <?php if ($promotion['status']) { ?>
                                            [ <a href="<?php echo $promotion['action_status']; ?>"><?php echo $text_enabled; ?></a> ]
                                        <?php } else { ?>
                                            [ <a href="<?php echo $promotion['action_status']; ?>"><?php echo $text_disabled; ?></a> ]
                                        <?php } ?>
                                    </td>
                                    <td><?php echo $promotion['sort_order']; ?></td>
                                    <td class="right">
                                        <?php foreach ($promotion['action'] as $action) { ?>
...
<script type="text/javascript"><!--
function filter() {
    var url = 'index.php?route=sale/special_promotions&token=<?php echo $token; ?>';
