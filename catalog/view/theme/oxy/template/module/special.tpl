<?php if($this->config->get('oxy_homepage_specials_status')== 0) { ?>
<div class="box">
  ...
  <div class="box-content">
    <div class="box-product">
      ...
      <div class="<?php echo $this->config->get('oxy_layout_pb_noc'); ?> mobile-two columns">
        ...
        <div class="image">
		<?php if (($product['special'])&&($this->config->get('oxy_category_sale_badge_status') == 1)) { ?><span class="sale-icon sale-icon-custom"><?php echo $text_sale; ?></span><?php } ?>
...
<?php if($this->config->get('oxy_homepage_specials_status')== 1) { ?>
...
<script type="text/javascript">
    jQuery(function($) {
      $('#slider2').flexslider({
        ...
        maxItems: 6,
        minItems: 1,
        controlsContainer: ".control-page .promo",
        manualControls: ".control-page.promo .total-page b"
       });
    });
</script>
<div class="products-slider box-content">       
<div class="product-box-slider-flexslider products-slider-slides" id="slider2">
   <ul class="slides">
       <?php $total_items = 0; ?>
    <?php foreach ($products as $product) { ?>
    <li>
