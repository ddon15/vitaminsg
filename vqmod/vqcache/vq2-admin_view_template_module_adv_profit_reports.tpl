...
<style type="text/css">
  ...
  <div class="box">
      ...
      <table class="form">
       ...
       <tr>
        ...
        <td>
          ...
          <a href="/opencart/admin/view/template/module/adv_reports/adv_extension_help.htm" id="adv_sop_help_notice">
          <?php } else { ?>
          <a href="view/template/module/adv_reports/adv_extension_help.htm" id="adv_sop_help_notice">
          <?php } ?> 
       ...
       <tr>
        ...
        <td><?php echo $adv_sop_text_copyright; ?>&nbsp;&nbsp;|&nbsp;&nbsp;
		  <?php if (defined('_JEXEC')) { ?>
          <a href="/opencart/admin/view/template/module/adv_reports/adv_extension_terms.htm" id="adv_sop_legal_notice">
          <?php } else { ?>
          <a href="view/template/module/adv_reports/adv_extension_terms.htm" id="adv_sop_legal_notice">
          <?php } ?> 		
	...
	<div style="border: 1px solid #ff9f00; margin-bottom:10px;">
      <table class="form">
       <tr>
        <td style="min-width:200px;"><?php echo $adv_ppp_text_ext_name; ?></td>
        <td style="min-width:400px;"><b><?php echo $adv_ppp_ext_name; ?></b></td>
       </tr>
       <tr>
        <td><?php echo $adv_ppp_text_ext_version; ?></td>
        <td><b><?php echo $adv_ppp_ext_version; ?></b> [ <?php echo $adv_ppp_ext_type; ?> ] <div id="adv_ppp_newversion"></div> <div id="adv_ppp_what_is_new"></div></td>
       </tr>
       <tr>
        <td><?php echo $adv_ppp_text_ext_compatibility; ?></td>
        <td><?php echo $adv_ppp_ext_compatibility; ?></td>
       </tr>
       <tr>
        <td><?php echo $adv_ppp_text_ext_url; ?></td>
        <td><a href="<?php echo $adv_ppp_ext_url; ?>" target="_blank"><?php echo $adv_ppp_ext_url ?></a></td>
       </tr>
       <tr>
        <td><?php echo $adv_ppp_text_ext_support; ?></td>
        <td>
          <a href="mailto:<?php echo $adv_ppp_ext_support; ?>?subject=<?php echo $adv_ppp_ext_subject; ?>" target="_blank"><?php echo $adv_ppp_ext_support; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;
          <span style="color:#F00;"><b>!!!</b></span> <a href="view/template/module/adv_reports/adv_extension_help.htm" id="adv_ppp_help_notice"><?php echo $text_asking_help; ?></a> <span style="color:#F00;"><b>!!!</b></span>
        </td>
       </tr>
       <tr>
        <td><?php echo $adv_ppp_text_ext_legal; ?></td>
        <td><?php echo $adv_ppp_text_copyright; ?>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="view/template/module/adv_reports/adv_extension_terms.htm" id="adv_ppp_legal_notice"><?php echo $text_terms; ?></a></td>
       </tr>
      </table>
	 </div>
...
<script type="text/javascript">
jQuery("#adv_cop_legal_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_cop_legal_text").load(this.href, function() {
        jQuery(this).dialog({
...
jQuery("#adv_cop_help_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_cop_help_text").load(this.href, function() {
        jQuery(this).dialog({
...
<script type="text/javascript">
jQuery('#adv_cop_newversion').append ('<span style=\"color:red\"><strong>There is new version <?php echo $adv_cop_version['version']; ?> for this extesion available!</strong></span>');
jQuery('#adv_cop_what_is_new').append('<?php echo html_entity_decode(str_replace("@@@","<br>",$adv_cop_version['whats_new']), ENT_QUOTES, 'UTF-8'); ?> ');
</script>
<?php } ?>
<?php } ?>
            

<div id="adv_ppp_legal_text" style="display:none"></div>
<div id="adv_ppp_help_text" style="display:none"></div>
<script type="text/javascript">
jQuery("#adv_ppp_legal_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_ppp_legal_text").load(this.href, function() {
        jQuery(this).dialog({
            title: '<?php echo $text_terms; ?>',
            width:  800,
            height:  600,
...
jQuery("#adv_ppp_help_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_ppp_help_text").load(this.href, function() {
        jQuery(this).dialog({
            title: '<?php echo $text_help_request; ?>',
            width:  800,
            height:  600,
...
<?php if ($adv_ppp_version) { ?>
<?php if ($adv_ppp_version['version'] != $adv_ppp_current_version) { ?>  
<script type="text/javascript">
jQuery('#adv_ppp_newversion').append ('<span style=\"color:red\"><strong>There is new version <?php echo $adv_ppp_version['version']; ?> for this extesion available!</strong></span>');
jQuery('#adv_ppp_what_is_new').append('<?php echo html_entity_decode(str_replace("@@@","<br>",$adv_ppp_version['whats_new']), ENT_QUOTES, 'UTF-8'); ?> ');
</script>
<?php } ?>
<?php } ?>
...
<script type="text/javascript">
jQuery("#adv_sop_legal_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_sop_legal_text").load(this.href, function() {
        jQuery(this).dialog({
            title: '<?php echo $text_terms; ?>',
            width:  800,
            height:  600,
...
jQuery("#adv_sop_help_notice").click(function(e) {
    e.preventDefault();
    jQuery("#adv_sop_help_text").load(this.href, function() {
        jQuery(this).dialog({
            title: '<?php echo $text_help_request; ?>',
            width:  800,
            height:  600,
...
<script type="text/javascript">
jQuery('#adv_sop_newversion').append ('<span style=\"color:red\"><strong>There is new version <?php echo $adv_sop_version['version']; ?> for this extesion available!</strong></span>');
jQuery('#adv_sop_what_is_new').append('<?php echo html_entity_decode(str_replace("@@@","<br>",$adv_sop_version['whats_new']), ENT_QUOTES, 'UTF-8'); ?> ');
</script>
<?php } ?>
<?php } ?>
