        ...
        <table class="list">
          <thead>
            <tr>
			  ...
			  <?php //[SB] Added expiry ?>
			  <td class="left"><?php if ($sort == 'member_num') { ?>
                <a href="<?php echo $sort_member_num; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_member_num; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_member_num; ?>"><?php echo $column_member_num; ?></a>
                <?php } ?></td>
			  ...
			  <?php //[SB] Added expiry ?>
			  <td class="left"><?php if ($sort == 'expiry') { ?>
                <a href="<?php echo $sort_expiry; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_expiry; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_expiry; ?>"><?php echo $column_expiry; ?></a>
                <?php } ?></td>
              ...
              <td class="left"><?php if ($sort == 'c.date_added') { ?>
                ...
                <?php } ?></td>
              <?php //[SB] Took out login to store ?>
                <td class="left"><?php if ($sort == 'claim_code') { ?>
                    <a href="<?php echo $sort_claim_code; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_claim_code; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_claim_code; ?>"><?php echo $column_claim_code; ?></a>
                    <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              <td></td>
			  <?php //[SB] Added filter member num ?>
			  <td><input type="text" name="filter_member_num" value="<?php echo $filter_member_num; ?>" /></td>
              ...
              <?php //[SB] Took out filter ip, added filter expiry ?>
			  <td><input type="text" name="filter_expiry" value="<?php echo $filter_expiry; ?>" size="12" id="date" /></td>
              <td><input type="text" name="filter_date_added" value="<?php echo $filter_date_added; ?>" size="12" id="date" /></td>
                <td><input type="text" name="filter_claim_code" size="10" maxlength="20" value="<?php echo $filter_claim_code; ?>" /></td>
              <?php //[SB] Took out empty column for filter login to store ?>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($customer['selected']) { ?>
                ...
                <?php } ?></td>
				<?php //[SB] Added Member Num ?>
			  <td class="left"><?php echo $customer['member_num']; ?></td>
              <td class="left"><?php echo $customer['name']; ?></td>
              <td class="left"><?php echo $customer['email']; ?></td>
              <td class="left"><?php echo $customer['customer_group']; ?></td>
              <td class="left"><?php echo $customer['status']; ?></td>
              <td class="left"><?php echo $customer['approved']; ?></td>
              <?php //[SB] Took out ip, added expiry ?>
			  <td class="left"><?php echo $customer['expiry']; ?></td>
              <td class="left"><?php echo $customer['date_added']; ?></td>
              <?php //[SB] Took out login to store ?>
                <td class="left"><?php echo $customer['claim_code']; ?></td>
...
function filter() {
	...
	//[SB] Added Member Num
	var filter_member_num = $('input[name=\'filter_member_num\']').attr('value');
	
	if (filter_member_num) {
		url += '&filter_member_num=' + encodeURIComponent(filter_member_num);
	}
	...
	*/
	var filter_expiry = $('input[name=\'filter_expiry\']').attr('value');
	
	if (filter_expiry) {
		url += '&filter_expiry=' + encodeURIComponent(filter_expiry);
	}
