        ...
        <div id="tab-general">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><input name="name" value="<?php echo $name; ?>" size="128"/>
            ...
            <tr>
              ...
              <td><input type="text" name="code" value="<?php echo $code; ?>" size="40"/>
            ...
            <tr>
              ...
              <td><select name="type">
				  ...
				  <?php if ($type == 'M') { //[SB] Added Member Price coupon ?>

                  <option value="M" selected="selected"><?php echo $text_member; ?></option>

                  <?php } else { ?>

                  <option value="M"><?php echo $text_member; ?></option>
            ...
            <?php //.[MY]?>
              ...
              <tr>
                  ...
                  <td><?php echo $entry_exclude_manufacturer; ?></td>

                  <td><input type="text" name="exclude_manufacturer" value="" /></td>
              ...
              <tr>
                  ...
                  <td><div id="coupon-exclude-manufacturer" class="scrollbox">

                          <?php $class = 'odd'; ?>

                          <?php foreach ($coupon_exclude_manufacturer as $coupon_exclude_manufacturer) { ?>

                          <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>

                          <div id="coupon-exclude-manufacturer<?php echo $coupon_exclude_manufacturer['manufacturer_id']; ?>" class="<?php echo $class; ?>"> <?php echo $coupon_exclude_manufacturer['name']; ?><img src="view/image/delete.png" alt="" />

                              <input type="hidden" name="coupon_exclude_manufacturer[]" value="<?php echo $coupon_exclude_manufacturer['manufacturer_id']; ?>" />
			...
			<tr>
              ...
              <td><?php echo $entry_exclude_product; ?></td>

              <td><input type="text" name="exclude_product" value="" /></td>
            ...
            <tr>
              ...
              <td><div id="coupon-exclude-product" class="scrollbox">

                  <?php $class = 'odd'; ?>

                  <?php foreach ($coupon_exclude_product as $coupon_exclude_product) { ?>

                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>

                  <div id="coupon-exclude-product<?php echo $coupon_exclude_product['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $coupon_exclude_product['name']; ?><img src="view/image/delete.png" alt="" />

                    <input type="hidden" name="coupon_exclude_product[]" value="<?php echo $coupon_exclude_product['product_id']; ?>" />
...
//[SB] Added Exclude Product

$('input[name=\'exclude_product\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#coupon-exclude-product' + ui.item.value).remove();

		

		$('#coupon-exclude-product').append('<div id="coupon-exclude-product' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="coupon_exclude_product[]" value="' + ui.item.value + '" /></div>');
		...
		$('input[name=\'exclude_product\']').val('');
...
$('#coupon-exclude-product div img').live('click', function() {

	$(this).parent().remove();

	

	$('#coupon-exclude-product div:odd').attr('class', 'odd');

	$('#coupon-exclude-product div:even').attr('class', 'even');	
...
$('input[name=\'manufacturer\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#coupon-manufacturer').append('<div id="coupon-manufacturer' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="coupon_manufacturer[]" value="' + ui.item.value + '" /></div>');
...
//[SB] Added Exclude Manufacturer

$('input[name=\'exclude_manufacturer\']').autocomplete({
	...
	select: function(event, ui) {
		...
		$('#coupon-exclude-manufacturer' + ui.item.value).remove();

		

		$('#coupon-exclude-manufacturer').append('<div id="coupon-exclude-manufacturer' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="coupon_exclude_manufacturer[]" value="' + ui.item.value + '" /></div>');



		$('#coupon-exclude-manufacturer div:odd').attr('class', 'odd');

		$('#coupon-exclude-manufacturer div:even').attr('class', 'even');

		

		$('input[name=\'exclude_manufacturer\']').val('');
...
$('#coupon-exclude-manufacturer div img').live('click', function() {
