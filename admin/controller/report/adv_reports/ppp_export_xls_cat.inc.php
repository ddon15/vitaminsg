...
ini_set("memory_limit","256M");
	...
	isset($_POST['ppp30']) ? $export_xls_cat .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['tax']."</td>" : '';
	isset($_POST['ppp29']) ? $export_xls_cat .= "<td align='right' valign='top' style='background-color:#DCFFB9; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['prod_sales']."</td>" : '';
	isset($_POST['ppp31']) ? $export_xls_cat .= "<td align='right' valign='top' style='background-color:#ffd7d7; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".('-' . $result['prod_costs'])."</td>" : '';
	isset($_POST['ppp32']) ? $export_xls_cat .= "<td align='right' valign='top' style='background-color:#c4d9ee; font-weight:bold; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['prod_profit']."</td>" : '';
	...
	isset($_POST['ppp30']) ? $export_xls_cat .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['tax_total']."</td>" : '';
	isset($_POST['ppp29']) ? $export_xls_cat .= "<td align='right' style='background-color:#DCFFB9; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['sales_total']."</td>" : '';
	isset($_POST['ppp31']) ? $export_xls_cat .= "<td align='right' style='background-color:#ffd7d7; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".('-' . $result['costs_total'])."</td>" : '';
	isset($_POST['ppp32']) ? $export_xls_cat .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['profit_total']."</td>" : '';
