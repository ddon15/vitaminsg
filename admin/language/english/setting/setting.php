...
//$_['entry_invoice_prefix']         = 'Invoice Prefix:<br /><span class="help">Set the invoice prefix (e.g. INV-2011-00). Invoice ID\'s will start at 1 for each unique prefix</span>'; //[SB] Changed invoice to order confirmation
$_['entry_invoice_prefix'] = 'Non-Member Order Confirmation Number:<br /><span class="help">Set the order confirmation number prefix for non members.</span>';
$_['entry_invoice_member_prefix'] = 'Member Order Confirmation Number:<br /><span class="help">Set the order confirmation number prefix for members.</span>';
