<div class="left">
  ...
  <?php echo $entry_dob; ?><br />
  <input type="text" class="date" name="dob" value="<?php echo $dob; ?>" class="large-field" />
  <br />

  <span class="required">*</span> <?php echo $entry_password; ?><br />
  <input type="password" name="password" value="<?php echo $password; ?>" class="large-field" />
  <br />

  <span class="required">*</span> <?php echo $entry_confirm; ?><br />
  <input type="password" name="confirm" value="<?php echo $confirm; ?>" class="large-field" />
  <br />
...
<div class="right">
  ...
  <br />
<?php //[SB] changed id so that display:none won't be triggered ?>
  <span id="payment-postalcode-required" class="required">*</span> <?php echo $entry_postcode; ?><br />
