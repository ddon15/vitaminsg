...
<?php } ?>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
				...
				<?php //[SB] Added Redemption, leave the hidden price etc intact for updates

				if($order_product['total_points'] > 0) { ?>

					<td class="right"><?php echo $text_redemption_price . $order_product['unit_points']; ?>
...
<?php } ?>	
					...
					<td class="right"><?php echo $text_redemption_total . $order_product['total_points']; ?>
					  ...
					  <input type="hidden" name="order_product[<?php echo $product_row; ?>][redeem_price]" value="<?php echo $order_product['unit_points']; ?>" />

					   <input type="hidden" name="order_product[<?php echo $product_row; ?>][redeem_total]" value="<?php echo $order_product['total_points']; ?>" />
...
<?php } ?>	
					...
					<td class="right"><?php echo $order_product['total']; ?>
					  ...
					  <input type="hidden" name="order_product[<?php echo $product_row; ?>][redeem_price]" value="0" />

					   <input type="hidden" name="order_product[<?php echo $product_row; ?>][redeem_total]" value="0" />
          ...
          <table class="list">
            ...
            <tbody id="total">
              ...
              <tr>
				...
				if($order_product['total_points'] > 0) { ?>
					...
					<td class="right vitline"><?php echo $text_redemption_price . $order_product['unit_points']; ?></td>

					<td class="right vitline"><?php echo $text_redemption_total . $order_product['total_points']; ?></td>
			...
			if($redeem_total > 0) { ?>
				...
				<tr id="total-row<?php echo $total_row; ?>">
					...
					<td class="right vitline" colspan="3"><?php echo $text_redemption_redeem_l; ?>:
			...
			<?php } ?>
              ...
              <tr id="total-row<?php echo $total_row; ?>">
				...
				<? //[SB] Changed colspan from 4 to 3 ?>
          ...
          <table class="list">
            ...
            <tbody>
              ...
              <tr>
				...
				<?php //[SB] Added rewards

				if (($reward || $reward_additional) && $customer) { ?>

				<td>&nbsp;<?php echo $reward; ?>

					<?php 

					if($reward_additional) {

						foreach ($reward_additional as $key => $value) {?>

							&nbsp;+&nbsp<?php echo $value; ?> (<?php echo $key; ?>)
			  ...
			  <tr>
                ...
                <td class="left"><?php echo $entry_referral; ?></td>

				<?php if (!empty($referrer_id)) { ?>

				<td>&nbsp;<?php echo $referrer_email; ?>

	

				  <?php if (!$referrer_rewarded) { ?>

				  <span id="referral"><b>[</b> <a id="referral-confirm"><?php echo $text_referral_confirm; ?></a> <b>]</b></span>

				  <?php } else { ?>

				  <span id="referral"><b>[</b> <a id="referral-remove"><?php echo $text_referral_remove; ?></a> <b>]</b></span>
			  ...
			  <tr>
				...
				<td class="left"><a href="<?php echo $affiliate; ?>"><?php echo $affiliate_firstname; ?> <?php echo $affiliate_lastname; ?></a></td>

			  </tr>

			  <tr>

				<td class="left"><?php echo $text_commission; ?></td>

				<td class="left"><?php echo $commission; ?>
...
//[SB] Added rewards and commissions control
...
$('#referral-confirm').live('click', function() {

	$.ajax({

		url: 'index.php?route=sale/order/confirmreferral&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&referrer_id=<?php echo $referrer_id; ?>',
		...
		beforeSend: function() {
			...
			$('#referral').after('<img src="view/image/loading.gif" class="loading" style="padding-left: 5px;" />');			
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#referral').html('<b>[</b> <a id="referral-remove"><?php echo $text_referral_remove; ?></a> <b>]</b>');
...
$('#referral-remove').live('click', function() {

	$.ajax({

		url: 'index.php?route=sale/order/removereferral&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#referral').html('<b>[</b> <a id="referral-confirm"><?php echo $text_referral_confirm; ?></a> <b>]</b>');
