        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <?php/*CPT1 START*/?><tr><td><?php echo $entry_cptitle; ?></td><td><input type="text" id="cpinfo" name="category_description[<?php echo $language['language_id']; ?>][cptitle]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['cptitle'] : ''; ?>" /></td></tr><?php/*CPT1 END*/?>
              <tr>
