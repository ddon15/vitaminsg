                ...
                <table class="form">
                    <tr>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="promotion_sort_order" value="<?php echo $promotion_sort_order; ?>" size="1" /></td>
                    </tr>
                </table>
            </form>
        </div>
        <p style="text-align:center; color:#222;">Promotions OpenCart Module v<?php echo $version; ?></p>
    </div>
</div>
<?php echo $footer; ?>
