...
<section id="content" class="columns op"><?php echo $content_top; ?>
  ...
  <div class="checkout-heading"><?php echo $text_enter_coupon_hint; ?></div>
  <div class="checkout">
    <div id="checkout">
...
$('#button-account').live('click', function() {
	//[SB] Go to Register Member if registering new account
	if($('#checkout .checkout-content input[id=\'register\']').attr('checked') == 'checked') {
