...
<section id="content" class="columns op"><?php echo $content_top; ?>
  ...
  <div class="content">
    <p><?php echo $entry_search; ?>
      ...
      <select name="category_id" id="category_id">
        ...
        <?php } else { ?>
        <?php if($category_2['category_id'] != "" && $category_2['category_id'] != "132" && $category_2['category_id'] != "133" && $category_2['category_id'] != "134") { ?>
  ...
  <div class="product-list">
    ...
    <div class="overflow-hidden <?php echo $this->config->get('oxy_layout_pb_noc'); ?> mobile-two columns" data-no-bottles="<?php echo $product['no_bottles']; ?>">
...
function display(view) {
	if (view == 'list') {
		...
		$('.product-grid > div').each(function(index, element) {
			...
			if (image != null) {
				html += '<div class="ribbon-wrapper">' + image + '</div>';
			}
