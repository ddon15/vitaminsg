...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			//[SB] Added invoice
			$invoice = $result['invoice_prefix'] . sprintf('%04d', $result['invoice_no']);

			$this->data['orders'][] = array(
				'order_id'   => $result['order_id'],
				'invoice'   => $invoice, //[SB] Added invoice
	...
	public function info() { 
		...
		if ($order_info) {
			...
			if ($order_info['invoice_no']) {
				$this->data['invoice_no'] = $order_info['invoice_prefix'] . sprintf('%04d', $order_info['invoice_no']);//[SB] Added 0 paddings
			} else {
