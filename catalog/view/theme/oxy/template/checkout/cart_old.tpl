    ...
    <table class="radio">
      ...
      <tr class="highlight">
        <td><?php if ($next == 'coupon') { ?>
          ...
          <?php } ?></td>
        <td><label for="use_coupon"><?php echo "Yes";//$text_use_coupon; ?></label></td>
      </tr>
      <tr class="highlight">
        <td><?php if ($next == 'coupon') { ?>
          <input type="radio" name="next" value="false" id="no_coupon" />
          <?php } else { ?>
          <input type="radio" name="next" value="false" id="no_coupon" />
          <?php } ?></td>
        <td><label for="use_coupon"><?php echo "No"; ?></label></td>
      </tr>
      <?// [MY] end changes for coupon codes?>
      <?php } ?>
