  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<?php //[SB] Added Bestseller insertion ?>
		<table class="form">
          <tr>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><div id="bestseller-product" class="scrollbox">
                <?php $class = 'odd'; ?>
                <?php foreach ($products as $product) { ?>
                <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                <div id="bestseller-product<?php echo $product['product_id']; ?>" class="<?php echo $class; ?>"><?php echo $product['name']; ?> <img src="view/image/delete.png" alt="" />
                  <input type="hidden" value="<?php echo $product['product_id']; ?>" />
                </div>
                <?php } ?>
              </div>
              <input type="hidden" name="bestseller_product" value="<?php echo $bestseller_product; ?>" /></td>
          </tr>
        </table>
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(event, ui) {
		$('#bestseller-product' + ui.item.value).remove();
		
		$('#bestseller-product').append('<div id="bestseller-product' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" value="' + ui.item.value + '" /></div>');

		$('#bestseller-product div:odd').attr('class', 'odd');
		$('#bestseller-product div:even').attr('class', 'even');
		
		data = $.map($('#bestseller-product input'), function(element){
			return $(element).attr('value');
		});
						
		$('input[name=\'bestseller_product\']').attr('value', data.join());
...
$('#bestseller-product div img').live('click', function() {
	$(this).parent().remove();
