...
ini_set("memory_limit","256M");
	...
	isset($_POST['cop1000']) ? $export_xls_all_details .= "<td align='left' style='background-color:#EFEFEF; font-weight:bold;'>".$this->language->get('column_order_inv_no')."</td>" : '';	
	...
	isset($_POST['cop1000']) ? $export_xls_all_details .= "<td align='left' valign='top' style='mso-ignore: colspan'>".$result['order_inv_no']."</td>" : '';
	...
	isset($_POST['cop1020']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_sub_total']."</td>" : '';	
	isset($_POST['cop1023']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_shipping']."</td>" : '';
	isset($_POST['cop1027']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_tax']."</td>" : '';
	isset($_POST['cop1031']) ? $export_xls_all_details .= "<td align='right' valign='top' style='mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_value']."</td>" : '';
	isset($_POST['cop1032']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#DCFFB9; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_sales']."</td>" : '';
	isset($_POST['cop1037']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#ffd7d7; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>-".$result['order_costs']."</td>" : '';
	isset($_POST['cop1038']) ? $export_xls_all_details .= "<td align='right' valign='top' style='background-color:#c4d9ee; font-weight:bold; mso-ignore: colspan; mso-number-format:#\,\#\#0\.00'>".$result['order_profit']."</td>" : '';
	...
	isset($_POST['cop1040']) ? $export_xls_all_details .= "<td align='left' valign='top' style='mso-ignore: colspan'>".strip_tags($result['order_shipping_method'], '<br>')."</td>" : '';
