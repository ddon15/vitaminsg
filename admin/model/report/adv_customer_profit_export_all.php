<?php
class ModelReportAdvCustomerProfitExportAll extends Model {
	public function getCustomerProfitExportAll($data = array()) {
		...
		switch($range) 
		{
			case 'custom';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < '" . $this->db->escape($data['filter_date_start']) . "'))";			
			...
			case 'week';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < '" . $this->db->escape(date('Y-m-d', strtotime('-7 day'))) . "'))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;
			case 'month';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < '" . $this->db->escape(date('Y-m-d', strtotime('-30 day'))) . "'))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;			
			case 'quarter';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < '" . $this->db->escape(date('Y-m-d', strtotime('-91 day'))) . "'))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;
			case 'year';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < '" . $this->db->escape(date('Y-m-d', strtotime('-365 day'))) . "'))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;
			case 'current_week';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < CURDATE() - WEEKDAY(CURDATE())))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}				
				break;	
			case 'current_month';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < CURDATE() - DAYOFMONTH(CURDATE()) + 1))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;
			case 'current_quarter';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < MAKEDATE(YEAR(CURDATE()), 1) + INTERVAL QUARTER(CURDATE()) QUARTER - INTERVAL 1 QUARTER))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}
				break;					
			case 'current_year';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < CURDATE() - YEAR(CURDATE())))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;					
			case 'last_week';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < CURDATE() - INTERVAL DAYOFWEEK(CURDATE())+5 DAY))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}				
				break;	
			case 'last_month';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < DATE_FORMAT(CURRENT_DATE - INTERVAL 1 MONTH, '%Y/%m/01')))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;
			case 'last_quarter';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < DATE_FORMAT(CURRENT_DATE - INTERVAL 1 QUARTER, '%Y/%m/01')))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;					
			case 'last_year';
				...
				if (isset($data['filter_types']) && $data['filter_types'] == 1) {
					...
					$type = " AND CONCAT(o.firstname, ' ', o.lastname) NOT IN (SELECT CONCAT(o.firstname, ' ', o.lastname) FROM `" . DB_PREFIX . "order` o WHERE (DATE(o.date_added) >= '" . $this->db->escape(date('Y-m-d','0')) . "') AND (DATE(o.date_added) < DATE_FORMAT(CURRENT_DATE - INTERVAL 1 YEAR, '%Y/01/01')))";			
				} elseif (isset($data['filter_types']) && $data['filter_types'] == 3) {
					$type = '';
				}					
				break;					
		...
		if (isset($this->request->post['export']) && ($this->request->post['export'] == 5)) {
		$sql = "SELECT *, 
		...
		(SELECT GROUP_CONCAT(op.order_id SEPARATOR '<br>') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_ord_idc, 
		(SELECT (SELECT DATE_FORMAT(o.date_added, '%e/%m/%Y') FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.date_added) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_order_date, 
		...
		(SELECT ROUND(o.currency_value*SUM(op.cost*op.quantity), 2) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_product_costs, 		
		(SELECT (SELECT ROUND(o.currency_value*o.commission, 2) FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.commission) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_commission, 
		(SELECT (SELECT ROUND(o.currency_value*o.payment_cost, 2) FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.payment_cost) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_payment_cost, 
		(SELECT (SELECT ROUND(o.currency_value*o.shipping_cost, 2) FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.shipping_cost) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_shipping_cost, 
		...
		(SELECT (SELECT IF (o.customer_id = 0,'&nbsp;',CONCAT('<a href=\"index.php?route=sale/customer/update&token=$token&customer_id=',o.customer_id,'\">',o.customer_id,'</a>')) FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.customer_id) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS customer_cust_id, 
		(SELECT (SELECT IF (o.customer_id = 0,'&nbsp;',o.customer_id) FROM `" . DB_PREFIX . "order` o WHERE op.order_id = o.order_id GROUP BY o.customer_id) FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS customer_cust_idc, 
