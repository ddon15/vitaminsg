      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
			<tr>
                <td> <?php echo $entry_member_num; ?></td>
                <td><?php echo $member_num; ?></td>
              </tr>
              <tr>
			  ...
			  <?php //[SB] Added member fields ?>
			  <tr>
                <td><?php echo $entry_id_number; ?></td>
                <td><input type="text" name="id_number" value="<?php echo $id_number; ?>" /></td>
              </tr>
			  <tr>
                <td><?php echo $entry_dob; ?></td>
                <td><input type="text" class="date hasDatePicker" name="dob" value="<?php echo $dob; ?>" /></td>
              </tr>
			  <tr>
			  ...
			  <tr>
                <td><?php echo $entry_expiry; ?></td>
                <td><input type="text" name="expiry" class="date hasDatePicker" value="<?php echo $expiry; ?>" /></td>
              </tr>
              ...
              <tr>
                ...
                <tr>
                <td><?php echo $entry_claim_code; ?></td>
                <td><?php echo $claim_code ?></td>
              </tr>
            </table>
          </div>
          <?php $address_row = 1; ?>
		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['zone'] != '') {
					...
					html += '<option value="0" selected="selected"><?php echo $text_none; ?></option>'; //[SB] Make "none" selected
				}
