...
class ControllerCommonHeader extends Controller {
	protected function index() {
                ...
                //[MY]
                if ($this->config->get('special_promotions_status')) {
                    $this->language->load('total/special_promotions');
                    $this->data['text_special_promotions'] = $this->language->get('text_special_promotions');
                    $this->data['text_promotions'] = $this->language->get('text_promotions');
                    $this->data['text_banners'] = $this->language->get('text_banners');
                  //  $this->data['text_triggers'] = $this->language->get('text_triggers');
                }//.[MY]
                
                //[MY] clearance products
                if($this->config->get('clearance_products_status')){
                    $this->language->load('sale/clearance_products');
                    $this->data['text_clearance_products'] = $this->language->get('text_clearance_products');
		...
		$this->data['text_report_customer_expiry'] = $this->language->get('text_report_customer_expiry');
		...
		$this->data['text_recurring_profile'] = $this->language->get('text_recurring_profile');
                ...
                $this->data['text_promotion'] = $this->language->get('text_promotion');//[MY]
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_customer_expiry'] = $this->url->link('report/customer_expiry', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['zone'] = $this->url->link('localisation/zone', 'token=' . $this->session->data['token'], 'SSL');
                        ...
                        //[MY]
                        if ($this->config->get('special_promotions_status')) {
                            $this->data['special_promotions'] = $this->url->link('sale/special_promotions', 'token=' . $this->session->data['token'], 'SSL');
                            $this->data['special_banners'] = $this->url->link('sale/special_banners', 'token=' . $this->session->data['token'], 'SSL');
                          //  $this->data['special_triggers'] = $this->url->link('sale/special_triggers', 'token=' . $this->session->data['token'], 'SSL');
                            $this->data['report_special_promotions'] = $this->url->link('report/special_promotions', 'token=' . $this->session->data['token'], 'SSL');
                        }
                        //.[MY]
                        //[MY]Clearance products
                        if ($this->config->get('clearance_products_status')) {
                            $this->data['clearance_products'] = $this->url->link('sale/clearance_products', 'token=' . $this->session->data['token'], 'SSL');
                        }
                        //[MY]
