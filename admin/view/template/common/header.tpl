    ...
    <ul class="left" style="display: none;">
      ...
      <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $custom_settings; ?>"><?php echo $text_custom_settings; ?></a></li>
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <?php //[MY]?>
          <?php if(!empty($text_clearance)) { ?>
                <li><a href="<?php echo $clearance_products; ?>"><?php echo $text_clearance; ?></a></li>
          <?php }?>
          <?php //.[MY]?>
          <?php //[MY]?>
        ...
        <ul>
          ...
          <li><a class="parent"><?php echo $text_customer; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $report_customer_expiry; ?>"><?php echo $text_report_customer_expiry; ?></a></li>
