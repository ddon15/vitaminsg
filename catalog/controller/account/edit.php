...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		...
		$this->load->model('premium_member/db'); //[SB] Added premium member db load
		...
		//[SB] Added DOB Instructions
		$this->data['text_dob_instructions'] = $this->language->get('text_dob_instructions');
		//[SB] Added Male, Female
		...
		//$this->data['entry_fax'] = $this->language->get('entry_fax'); //[SB] Removed fax, added DOB and gender
		...
		if ($this->request->server['REQUEST_METHOD'] != 'POST') {
			...
			$premium_member_info = $this->model_premium_member_db->getPremiumCustomer($this->customer->getId());
		}
		...
		*/
		...
		} elseif (isset($premium_member_info)) {
			$this->data['dob'] = $premium_member_info['DOB'];
		} else {
			$this->data['dob'] = '';
		}
		
		//[SB] Added gender post
		if (isset($this->request->post['gender'])) {
			$this->data['gender'] = $this->request->post['gender'];
		} elseif (isset($premium_member_info)) {
			$this->data['gender'] = $premium_member_info['gender'];
		} else {
			$this->data['gender'] = '';
		}
