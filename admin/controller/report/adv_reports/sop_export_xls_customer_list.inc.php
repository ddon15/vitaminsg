...
ini_set("memory_limit","256M");
	...
	isset($_POST['sop23']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['sub_total']."</td>" : '';
	isset($_POST['sop24']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['handling']."</td>" : '';
	isset($_POST['sop25']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['low_order_fee']."</td>" : '';
	if ($this->config->get('adv_profit_reports_formula_sop1')) {
	isset($_POST['sop27']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['shipping']."</td>" : '';
	} else {
	isset($_POST['sop27']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".$result['shipping']."</td>" : '';
	}
	isset($_POST['sop26']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['reward']."</td>" : '';
	isset($_POST['sop28']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['coupon']."</td>" : '';
	isset($_POST['sop29']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".$result['tax']."</td>" : '';
	isset($_POST['sop30']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['credit']."</td>" : '';
	isset($_POST['sop31']) ? $export_xls_customer_list .= "<td align='right' style='color:#090; mso-number-format:#\,\#\#0\.00'>".$result['voucher']."</td>" : '';
	isset($_POST['sop33']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".$result['total']."</td>" : '';
	isset($_POST['sop37']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#DCFFB9; mso-number-format:#\,\#\#0\.00'>".$total_sales."</td>" : '';
	isset($_POST['sop34']) ? $export_xls_customer_list .= "<td align='right' style='color:#F00; mso-number-format:#\,\#\#0\.00'>".('-' . $result['prod_costs'])."</td>" : '';
	isset($_POST['sop32']) ? $export_xls_customer_list .= "<td align='right' style='color:#F00; mso-number-format:#\,\#\#0\.00'>".-$result['commission']."</td>" : '';
	if ($this->config->get('adv_profit_reports_formula_sop3')) {
	isset($_POST['sop391']) ? $export_xls_customer_list .= "<td align='right' style='color:#F00; mso-number-format:#\,\#\#0\.00'>".-$result['payment_cost']."</td>" : '';
	} else {
	isset($_POST['sop391']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".-$result['payment_cost']."</td>" : '';
	}	
	if ($this->config->get('adv_profit_reports_formula_sop2')) {
	isset($_POST['sop392']) ? $export_xls_customer_list .= "<td align='right' style='color:#F00; mso-number-format:#\,\#\#0\.00'>".-$result['shipping_cost']."</td>" : '';
	} else {
	isset($_POST['sop392']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".-$result['shipping_cost']."</td>" : '';
	}
	isset($_POST['sop393']) ? $export_xls_customer_list .= "<td align='right' style='mso-number-format:#\,\#\#0\.00'>".($result['shipping']-$result['shipping_cost'])."</td>" : '';	
	isset($_POST['sop38']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#ffd7d7; mso-number-format:#\,\#\#0\.00'>".('-' . $total_costs)."</td>" : '';
	isset($_POST['sop35']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".($total_sales-$total_costs)."</td>" : '';
	if ($total_costs > 0) {				
	isset($_POST['sop36']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold;'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; font-weight:bold;'>".'100%'."</td>" : '';
	}			
	$export_xls_customer_list .="</tr>";
	$export_xls_customer_list .="<tr>";
	...
	isset($_POST['sop23']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['sub_total_total']."</td>" : '';
	isset($_POST['sop24']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['handling_total']."</td>" : '';
	isset($_POST['sop25']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['low_order_fee_total']."</td>" : '';
	isset($_POST['sop27']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['shipping_total']."</td>" : '';
	isset($_POST['sop26']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['reward_total']."</td>" : '';
	isset($_POST['sop28']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['coupon_total']."</td>" : '';
	isset($_POST['sop29']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['tax_total']."</td>" : '';
	isset($_POST['sop30']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['credit_total']."</td>" : '';
	isset($_POST['sop31']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['voucher_total']."</td>" : '';
	isset($_POST['sop33']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$result['total_total']."</td>" : '';
	isset($_POST['sop37']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#DCFFB9; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".$total_sales_total."</td>" : '';
	isset($_POST['sop34']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".('-' . $result['prod_costs_total'])."</td>" : '';
	isset($_POST['sop32']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".-$result['commission_total']."</td>" : '';
	isset($_POST['sop391']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".-$result['pay_costs_total']."</td>" : '';
	isset($_POST['sop392']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".-$result['ship_costs_total']."</td>" : '';
	isset($_POST['sop393']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#E7EFEF; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".($result['shipping_total']-$result['ship_costs_total'])."</td>" : '';
	isset($_POST['sop38']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#ffd7d7; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".('-' . $total_costs_total)."</td>" : '';
	isset($_POST['sop35']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold; mso-number-format:#\,\#\#0\.00'>".($total_sales_total-$total_costs_total)."</td>" : '';
	if ($total_costs_total > 0) {
	isset($_POST['sop36']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold;'>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['sop36']) ? $export_xls_customer_list .= "<td align='right' style='background-color:#c4d9ee; color:#003A88; font-weight:bold;'>".'100%'."</td>" : '';	
	}
