        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'o.order_id') { ?>
                ...
                <?php } ?></td>
				<?php //[SB] Added sort invoice ?>
			<td class="left"><?php if ($sort == 'invoice') { ?>
          ...
          <tbody>
            <tr class="filter">
			  ...
			  <?php //[SB] Added filter invoice ?>
			  <td><input type="text" name="filter_invoice" value="<?php echo $filter_invoice; ?>" /></td>
              <td><input type="text" name="filter_customer" value="<?php echo $filter_customer; ?>" /></td>
			  <?php //[SB] Added filter email ?>
            ...
            <tr>
			  ...
			  <?php //[SB] Added invoice ?>
			  <td class="left"><?php echo $order['invoice']; ?></td>
...
function filter() {
	...
	var filter_invoice = $('input[name=\'filter_invoice\']').attr('value');
