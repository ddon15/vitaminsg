...
class ModelReportAdvSaleProfitExportAll extends Model {
	public function getSaleProfitExportAll($data = array()) { 	
		...
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'handling' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_handling, 
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'low_order_fee' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_low_order_fee, 
		...
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'reward' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_reward, 
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'coupon' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_coupon, 
		(SELECT IFNULL((SELECT CONCAT(cp.name,' [',cp.code,']') FROM `" . DB_PREFIX . "coupon` cp, `" . DB_PREFIX . "coupon_history` cph WHERE cph.order_id = op.order_id AND cph.coupon_id = cp.coupon_id),'&nbsp;') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_coupon_code, 		
		...
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'credit' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_credit, 
		(SELECT IFNULL((SELECT ROUND(o.currency_value*SUM(ot.value), 2) FROM `" . DB_PREFIX . "order_total` ot WHERE op.order_id = o.order_id AND ot.order_id = o.order_id AND ot.code = 'voucher' GROUP BY ot.order_id),'0') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_voucher, 
		(SELECT IFNULL((SELECT v.code FROM `" . DB_PREFIX . "voucher` v, `" . DB_PREFIX . "voucher_history` vh WHERE vh.order_id = op.order_id AND vh.voucher_id = v.voucher_id),'&nbsp;') FROM `" . DB_PREFIX . "order_product` op WHERE op.order_id = o.order_id GROUP BY op.order_id) AS order_voucher_code, 
