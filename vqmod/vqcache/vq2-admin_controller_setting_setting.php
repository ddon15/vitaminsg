...
if (isset($this->request->get['keepediting'])) {
		...
		$this->data['entry_invoice_member_prefix'] = $this->language->get('entry_invoice_member_prefix'); //[SB] Added member prefix
		...
		if (isset($this->request->post['config_invoice_member_prefix'])) {
			$this->data['config_invoice_member_prefix'] = $this->request->post['config_invoice_member_prefix'];
		} elseif ($this->config->get('config_invoice_member_prefix')) {
			$this->data['config_invoice_member_prefix'] = $this->config->get('config_invoice_member_prefix');			
		} else {
			$this->data['config_invoice_member_prefix'] = 'INV-' . date('Y') . '-00';
		}
