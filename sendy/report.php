    	...
    	<div class="row-fluid">
	    	<div class="span6">
	    		<div class="well">
			    	...
			    	<h3 style="float:left;"><span class="badge badge-warning" style="font-size:16px;"><?php echo $recipients - $opens_unique;?></span> <?php echo _('not opened');?> </h3> <a href="<?php echo get_app_info('path');?>/includes/reports/export-csv.php?c=<?php echo $id?>&a=unopens" title="<?php echo _('Export subscribers who did not open this email (includes subscribers newly added to the lists after this campaign was sent)');?>" style="float:left; margin: 5px 0 0 7px;"><i class="icon icon-download-alt"></i></a><br/>
