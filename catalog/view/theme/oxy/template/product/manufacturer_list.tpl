  ...
  <div class="manufacturer-list">
    ...
    <div class="manufacturer-content">
      ...
      <ul>
		...
		<?php if(!empty($category['manufacturer'][$i]['thumb'])) { ?>
			<li style="margin:15px;"><a href="<?php echo $category['manufacturer'][$i]['href']; ?>">
			<img src="<?php echo $category['manufacturer'][$i]['thumb'] ?>" />
			</a></li>
		<?php } else { ?>
			<?php $j++; // to cater for missing li in the ul  ?>
		<?php } ?>
        <?php } ?>
        <?php } ?>
      </ul>
