...
ini_set("memory_limit","256M");
	...
	isset($_POST['sop1000']) ? $export_pdf_all_details .= "<td align='left' style='background-color:#F0F0F0; padding:0px 3px; font-size:11px; font-weight: bold;'>".$this->language->get('column_order_inv_no')."</td>" : '';
