...
ini_set("memory_limit","256M");
	...
	isset($_POST['cop29']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#DCFFB9;'>".$this->currency->format($total_sales, $this->config->get('config_currency'))."</td>" : '';
	isset($_POST['cop31']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#ffd7d7;'>".$this->currency->format('-' . ($total_costs), $this->config->get('config_currency'))."</td>" : '';	
	isset($_POST['cop32']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; font-weight:bold;'>".$this->currency->format(($total_sales-$total_costs), $this->config->get('config_currency'))."</td>" : '';
	if (($total_costs) > 0) {
	isset($_POST['cop33']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; font-weight:bold;'>".round(100 * (($total_sales-$total_costs) / $total_sales), 2) . '%'."</td>" : '';
	} else {
	isset($_POST['cop33']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; font-weight:bold;'>".'100%'."</td>" : '';
	}							
	$export_html_product_list .="</tr>";
	$export_html_product_list .="<tr>";
	...
	isset($_POST['cop29']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#DCFFB9; color:#003A88;'><strong>".$this->currency->format($total_sales_total, $this->config->get('config_currency'))."</strong></td>" : '';
	isset($_POST['cop31']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#ffd7d7; color:#003A88;'><strong>".$this->currency->format('-' . ($total_costs_total), $this->config->get('config_currency'))."</strong></td>" : '';
	isset($_POST['cop32']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; color:#003A88;'><strong>".$this->currency->format(($total_sales_total-$total_costs_total), $this->config->get('config_currency'))."</strong></td>" : '';
	if (($total_costs_total) > 0) {
	isset($_POST['cop33']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; color:#003A88;'><strong>".round(100 * (($total_sales_total-$total_costs_total) / $total_sales_total), 2) . '%'."</strong></td>" : '';
	} else {
	isset($_POST['cop33']) ? $export_html_product_list .= "<td align='right' nowrap='nowrap' style='background-color:#c4d9ee; color:#003A88;'><strong>".'100%'."</strong></td>" : '';	
	}
