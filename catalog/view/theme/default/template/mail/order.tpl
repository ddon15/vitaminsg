...
<div style="font-size:0px;content:'.';display:block;height:0px;visibility:hidden;clear:both;"></div>
  ...
  <p style="margin-top: 20px; margin-bottom: 20px;"><?php echo $text_greeting; ?></p>
  <?php if ($customer_id) { ?>
    ...
    <tbody>
      <tr>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_email; ?></b> <?php echo $email; ?><br />
		  ...
		  <?php if(isset($member_num)) {//[SB] Added member ?>
		  <b><?php echo $text_member_num; ?></b> <?php echo $member_num; ?><br />
          <?php } //[SB] Removed IP ?><br /></td>
      </tr>
    </tbody>
  </table>
  <?php if ($comment) { ?>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
		<td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;"><?php echo $text_sku; ?></td><?php //[SB] Added SKU ?>
		...
		<?php //[SB] Added usual price ?>
		<td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: right; padding: 7px; color: #222222;"><?php echo $text_usual_price; ?></td>
    ...
    <tbody>
      ...
      <tr>
		<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $product['sku']; ?></td>
		...
		if($product['redeem_only']) { ?>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $text_redemption_usual; ?></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo sprintf($text_redemption_price, $product['unit_points']); ?></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo sprintf($text_redemption_total, $product['total_points']); ?></td>
		<?php } else {?>
		<?php //[SB] Added usual price ?>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $product['usual_price']; ?></td>
    ...
    <tfoot>
		...
		if($redeem_total > 0) { ?>
		<tr>
			<?php //[SB] increased colspan ?>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="5"><b><?php echo $text_redemption_redeem_l; ?>:</b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo sprintf($text_redemption_redeem_r, $redeem_total); ?></td>
		</tr>
		<?php } ?>
      ...
      <tr>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo 'S' . $total['text']; //[SB] Hack added S in front of $ ?></td>
      </tr>
      <?php } ?>
    </tfoot>
  </table>
  
  <?php //[SB] Added customer comments
  if($order_comment) {  ?>
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
  ...
  <?php //[SB] Added Vit$
  if(!empty($vit_earned) || !empty($vit_redeemed)) {?>
  <table style="border-collapse: collapse; width: 50%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
        <td colspan="2" style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;"><?php echo $text_vit_dollars; ?></td>
      </tr>
    </thead>
    <tbody>
      <tr>
		<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_vit_opening?></b></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $vit_opening; ?></td>
      </tr>
	  <tr>
		<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_vit_earned?></b></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $vit_earned; ?></td>
      </tr>
	  <tr>
		<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_vit_redeemed?></b></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $vit_redeemed; ?></td>
      </tr>
	  <tr>
		<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_vit_closing?></b></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $vit_closing; ?></td>
      </tr>
    </tbody>
  </table>
  <?php } ?>
  ...
  <?php //[SB] Removed Powered OpenCart ?>
</div>
</body>
</html>
