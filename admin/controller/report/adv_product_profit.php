...
class ControllerReportAdvProductProfit extends Controller { 
	public function index() {
		...
		$this->data['tax_classes'] = $this->model_report_adv_product_profit->getOrderTaxClasses();					
		...
		$this->data['geo_zones'] = $this->model_report_adv_product_profit->getOrderGeoZones();					
		...
		$this->data['coupon_names'] = $this->model_report_adv_product_profit->getOrderCouponNames();
