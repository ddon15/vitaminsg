...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      ...
      <td><input type="text" name="address_1" value="" class="large-field" />
	  <span class="input_instructions"><?php echo $text_address_instructions; ?></span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><span id="shipping-postalcode-required" class="required">*</span> <?php echo $entry_postcode; ?></td>
